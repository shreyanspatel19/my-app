...
<br/>
  <div className="form-row">
    <div className={`col text-${props.mode==='light'?'black':'white'} `}><h5> {props.fn} </h5>
      <input type="text" value={texx}   onChange={handlon} style={props.mode==='dark'?color:colors} className="form-control" placeholder="Full name"/>
    </div>
    <div className="col"><h5>{props.ln}</h5>
      <input type="text" value={texx.toUpperCase()} style={props.mode==='dark'?color:colors} className="form-control" placeholder="upper case"/>
    </div>
    <div className="col"><h5>{props.ln}</h5>
      <input type="text" value={texx.toLowerCase()} style={props.mode==='dark'?color:colors}  className="form-control" placeholder="lower case"/>
    </div>
  <br/>
  </div>
  <div className="container">
